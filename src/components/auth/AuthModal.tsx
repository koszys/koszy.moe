            ...
            <div className="relative bg-[#18181b] border border-white/10 p-8 md:p-10 rounded-2xl max-w-sm w-full shadow-2xl flex flex-col items-center">
                ...
                <div className="flex flex-col gap-3 w-full">
                    <button
                        ...
                        className="flex items-center justify-center gap-3 w-full bg-white hover:bg-gray-100 text-gray-900 font-bold py-3 px-4 rounded-lg transition-colors shadow-sm"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-3 w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-sm"
                    >
